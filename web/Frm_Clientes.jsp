                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="Frm_Mantenimiento_Clientes.jsp?idCrearModificar=<%=codigo %>"> <i class="fas fa-user-edit">  
                            <!--Botón para Eliminar -->
                            <a href="EliminarClientes?idEliminar=<%=codigo %>"> <i class="fas fa-trash-alt"> 
|
                        </td>
                    </tr>
                    <%}%><!--Para cerrar el for --> 
             ...
             <a href="Frm_Mantenimiento_Clientes.jsp?idCrearModificar=-1"> Agregar un nuevo Cliente </a> 
