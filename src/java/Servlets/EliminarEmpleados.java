 ...
 * @author Fran
 */
public class EliminarEmpleados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           EntidadEmpleado empleado = new EntidadEmpleado();
            ...
            int resultado=logica.Eliminar(empleado);
            String mensaje=logica.getMensaje();
            mensaje=URLEncoder.encode(mensaje,"UTF-8" );
            //redireccionar a la pagina
           response.sendRedirect("Frm_Empleados.jsp?meCli=" + mensaje + "&resultado=" + resultado);
